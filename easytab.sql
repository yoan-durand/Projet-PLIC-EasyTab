...
CREATE TABLE IF NOT EXISTS `favoris` (
  ...
  `tablatureId` int(11) NOT NULL,
  PRIMARY KEY (`userId`,`tablatureId`),
  KEY `tablatureId` (`tablatureId`)
...
--
ALTER TABLE `favoris`
  ADD CONSTRAINT `favoris_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `favoris_ibfk_2` FOREIGN KEY (`tablatureId`) REFERENCES `tablature` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
